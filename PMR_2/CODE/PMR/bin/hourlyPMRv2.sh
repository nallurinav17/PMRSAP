...
/data/scripts/PMR/SAP/getCollectorStats-5min.sh | /data/scripts/PMR/bin/pmfile_writer.sh 05m
# Data Transfer Backlog
/data/scripts/PMR/SAP/getFDUtilization.sh | /data/scripts/PMR/bin/pmfile_writer.sh 1h
# FD Utilization
/data/scripts/PMR/SAP/getDcBacklog.sh | /data/scripts/PMR/bin/pmfile_writer.sh 1h
